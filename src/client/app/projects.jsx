          ...
          <div id="projects" style={{width: "700px"}}>
            <div className="column-1000">
              ...
              <div className="column-1-2" style={{marginLeft: "25%", float: "left"}}>
                ...
                <Project hang="left" title="Student Software Engineer" sub="UT Austin, Fall 2016 - Spring 2017">
                  {`Implemented database, server, and web app to handle statuses of
                    500 elevators at UT Austin `}
                </Project>
                <Project hang="left" title="Bioinformatics Research Assistant" sub="UT Austin, Summer 2016">
